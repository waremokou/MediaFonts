...
<html lang="en">
  <head>
    ...
    <title>ゴシック体｜わたしのすきなフリーフォントたち</title>
    ...
    <meta property="og:title" content="ゴシック体" />
      ...
      <article>
        ...
        <ul class="mainFlex">
          <li>
            <a href="./single.html">
              <dl>
                <dt><img src="./common/img/single/f_timemachine-wa_main.jpg" alt=""></dt>
                <dd>タイムマシンわ号</dd>
                <dd>ゴシック体</dd>
                <dd>商用：○</dd>
              </dl>
          ...
          <li>
            <a href="">
              <dl>
                <dt><img src="./common/img/single/nihongo_image2.gif" alt=""></dt>
                <dd>フォントポにほんご</dd>
                <dd>ゴシック体</dd>
                <dd>商用：○</dd>
              </dl>
          ...
          <li>
            <a href="">
              <dl>
                <dt><img src="./common/img/single/ex-theatrism.jpg" alt=""></dt>
                <dd>てあとりずむ</dd>
                <dd>ゴシック体</dd>
                <dd>商用：×</dd>
              </dl>
          ...
          <li>
            <a href="">
              <dl>
                <dt><img src="./common/img/single/f_cinderella_main.jpg" alt=""></dt>
                <dd>シンデレラ</dd>
                <dd>ゴシック体</dd>
                <dd>商用：○</dd>
              </dl>
